...
<div class="col-md-6">
    ...
    <form class="form-horizontal" method="post" action="ausw.php">
        <fieldset>
            ...
            <div class="btn-group>
    <button type=" button
            " class="btn btn-default" id="btn-info">Informationen</button>
            <button type="button" class="btn btn-default" id="btn-mensa">Speiseplan</button>
            <button type="button" class="btn btn-default" id="btn-geb">Geburtstage</button>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <input id="textinput" name="info" placeholder="Füll mich!" class="form-control input-md" required=""
               type="text">
    </div>
</div>
...
echo '<i><span style="color:#ff0000; font-size: 30px;">' . 'Aktuell zu sehen:<br />' . "\n" . '</i></span>';
